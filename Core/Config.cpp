...
static const ConfigSetting generalSettings[] = {
	...
	ConfigSetting("RemoteISOCacheSizeMB", SETTING(g_Config, iRemoteISOCacheSizeMB), 128, CfgFlag::PER_GAME),
	ConfigSetting("RemoteISOReadAhead", SETTING(g_Config, iRemoteISOReadAhead), 1048576, CfgFlag::PER_GAME),
	ConfigSetting("RemoteISOSocketBuffer", SETTING(g_Config, iRemoteISOSocketBuffer), 524288, CfgFlag::PER_GAME),
